...
from models.SpeakerResNet import spearkerresnet24, AngleLoss, spearkerresnet14
import os
import torch
...
def get_catalogue():
    model_creators = dict()
    model_creators['spearkerresnet24'] = spearkerresnet24
    model_creators['spearkerresnet14'] = spearkerresnet14
